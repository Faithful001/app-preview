...
const Integration = () => {
    return ( 
        <div className="integration px-14 py-5 flex flex-col gap-10">
            <h1 className="text-4xl font-semibold text-[#233966]">Pioneering AI Integration for Revolutionary Marketing.</h1>
            <div className="flex items-center justify-center gap-5">
                <div className="flex flex-col text-lg text-[#6493BD] gap-10">
                ...
                <img className="max-w-[40%] rounded-xl" src={chess_people} alt="" />
            </div>
        </div>
     );
}
